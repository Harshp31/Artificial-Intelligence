...
def update_patient(patient_id: str, patient_update: PatientUpdate):
    ...
    updated_patient = patient_update.model_dump(exclude_unset=True) #Exclude the firlds which are not provided in the update request.
    ...
    existing_patient_info = patient_pydantic_obj.model_dump(exclude='id') #Convert the pydantic object back to dict to save in the file.
